package org.ramaciotti.utilities.fcs;
 ...
 */
public class FlowJoPluginDataDumpFCS implements PopulationPluginInterface {
    ...
    public String getName() {
        return ("FlowJo Plugin Data Dump - FCS (.fcs file)");
    }
    /*
    ...
    public ExternalAlgorithmResults invokeAlgorithm(SElement fcmlElem, File sampleFile, File outputFolder) {
        ...
        JDialog window = new JDialog(new JFrame(), "FlowJo Plugin Data Dump - FCS (.fcs file)", true);
