package org.ramaciotti.utilities.csvchannel;
 ...
 */
public class FlowJoPluginDataDumpCSVChannel implements PopulationPluginInterface {
    ...
    public String getName() {
        return ("FlowJo Plugin Data Dump - CSV_CHANNEL (Transformed Values)");
    }
    /*
    ...
    public ExternalAlgorithmResults invokeAlgorithm(SElement fcmlElem, File sampleFile, File outputFolder) {
        ...
        JDialog window = new JDialog(new JFrame(), "FlowJo Plugin Data Dump - CSV_CHANNEL (Transformed Values)", true);
