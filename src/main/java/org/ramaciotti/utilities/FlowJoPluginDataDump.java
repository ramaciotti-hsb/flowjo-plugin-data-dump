 ...
 */
public class FlowJoPluginDataDump implements PopulationPluginInterface {
    ...
    public String getName() {
        return ("FlowJo Plugin Data Dump");
    }
    /*
    ...
    public ExternalAlgorithmResults invokeAlgorithm(SElement fcmlElem, File sampleFile, File outputFolder) {
        ...
        JDialog window = new JDialog(new JFrame(), "FlowJo Plugin Data Dump", true);
